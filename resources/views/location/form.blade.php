...
<body class="min-h-screen bg-gray-100 py-8">
    <div class="max-w-2xl mx-auto bg-white shadow-lg rounded-lg p-8">
        <div class="text-center mb-8">
            ...
            <p class="text-gray-600">Fill in your details and click "Get My Location" to capture your current location
            </p>
        </div> <!-- Status Message -->
        ...
        <form id="locationForm" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="latitude" name="latitude" readonly placeholder="Will be auto-detected"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm bg-gray-50 text-gray-600">
                </div>

                <div>
                    <label for="longitude" class="block text-sm font-medium text-gray-700 mb-2">Longitude</label>
                    <input type="text" id="longitude" name="longitude" readonly placeholder="Will be auto-detected"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm bg-gray-50 text-gray-600">
                </div>
            </div>
